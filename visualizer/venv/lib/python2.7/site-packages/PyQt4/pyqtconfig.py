...
_pkg_config = {
    'pyqt_bin_dir':      '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/bin',
    'pyqt_config_args':  '-q /opt/local/libexec/qt4/bin/qmake --verbose --confirm-license -e QtGui -e QtHelp -e QtMultimedia -e QtNetwork -e QtDeclarative -e QtOpenGL -e QtScript -e QtScriptTools -e QtSql -e QtSvg -e QtTest -e QtWebKit -e QtXml -e QtXmlPatterns -e QAxContainer -e QtDesigner --dbus=/opt/local/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7/dbus-1.0 --no-qsci-api --use-arch=x86_64 CC=/usr/bin/clang CXX=/usr/bin/clang++ LFLAGS=-F/opt/local/Library/Frameworks -L/opt/local/lib -Wl,-headerpad_max_install_names CFLAGS=-Os -pipe CXXFLAGS=-Os -stdlib=libc++ -pipe',
    'pyqt_mod_dir':      '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/PyQt4',
    ...
    'pyqt_sip_dir':      '/opt/local/share/py27-sip/PyQt4',
    ...
    'qt_archdata_dir':   '/opt/local/libexec/qt4/share',
    'qt_data_dir':       '/opt/local/libexec/qt4/share',
    'qt_dir':            '/opt/local/libexec/qt4',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_framework_dir':  '/opt/local/libexec/qt4/Library/Frameworks',
    'qt_inc_dir':        '/opt/local/libexec/qt4/include',
    'qt_lib_dir':        '/opt/local/libexec/qt4/lib',
    'qt_threaded':       1,
    'qt_version':        0x040807,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'FRAMEWORKDIR_QT':          '/opt/local/libexec/qt4/Library/Frameworks',
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '/System/Library/Frameworks/OpenGL.framework/Headers 	/System/Library/Frameworks/AGL.framework/Headers/',
    'INCDIR_QT':                '/opt/local/libexec/qt4/include',
    'INCDIR_X11':               '',
    'LFLAGS':                   '-F/opt/local/Library/Frameworks -L/opt/local/lib -Wl,-headerpad_max_install_names',
    'LFLAGS_CONSOLE':           '',
    'LFLAGS_CONSOLE_DLL':       '',
    'LFLAGS_DEBUG':             '',
    'LFLAGS_DLL':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/opt/local/libexec/qt4/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
